...
class EdgeSE3ProjectDirectWithDistort{
public:
...
EdgeSE3ProjectDirectWithDistort() {}

EdgeSE3ProjectDirectWithDistort(std::vector<Eigen::Vector3d> points, double *D, double *K, double *imageSize, float *maskDT, Eigen::Matrix<double, 6, 1> xi) {
    x_worlds_ = points;
    k1_ = D[0];
    k2_ = D[1];
    k3_ = D[2];
