function [mount_z, mount_pitch, mount_roll] = linefit_ground_estimation(groundSegmentParams, input_point_cloud)
  ...
  mount_pitch = extrinsicParamsEuler(2) * 180 / pi;
  mount_roll = extrinsicParamsEuler(3) * 180 / pi;
end