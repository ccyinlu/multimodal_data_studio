...
GroundSegmentation::GroundSegmentation(const GroundSegmentationParams& params) :
  ...
  // std::cout << "n_segments: " << params.n_segments << std::endl;
  // std::cout << "max_slope: " << params.max_slope << std::endl;
  // std::cout << "max_error_square: " << params.max_error_square << std::endl;
  // std::cout << "long_threshold: " << params.long_threshold << std::endl;
  // std::cout << "max_long_height: " << params.max_long_height << std::endl;
  // std::cout << "max_start_height: " << params.max_start_height << std::endl;
  // std::cout << "sensor_height: " << params.sensor_height << std::endl;
}
...
void GroundSegmentation::getLines(std::list<PointLine> *lines) {
  ...
  //single thread to process the getLines
  // std::mutex line_mutex;
  // lineFitThread(0, params_.n_segments, lines, &line_mutex);
}
...
void GroundSegmentation::assignCluster(std::vector<int>* segmentation) {
  ...
  // single thread to process assign cluster
...
void GroundSegmentation::insertPoints(const PointCloud& cloud) {
  ...
  // std::cout << "points_per_thread: " << points_per_thread << std::endl;
  // Launch threads.
  ...
  // single thread to process the segmentation
